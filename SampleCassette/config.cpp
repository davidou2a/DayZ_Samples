class CfgPatches
{
	class H2A_DayZ_Samples_SampleCassette
	{
		...
		requiredAddons[] = 
		{
			"DZ_Data", 
			"DZ_Sounds_Effects",
			"H2A_HellRetexSurvival_Contents", // Will be replaced soon by "HRS_Items" and "HRS_Items_cfg"
			"HRS_Scripts" // Since 2021/01/17 "HRS_Scripts" replace "H2A_HellRetexSurvival_Scripts"
		};
	};
};
